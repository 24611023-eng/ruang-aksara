...
<div class="min-h-screen py-3 admin-container" style="margin: 0 !important; padding: 0 !important;">
    <div class="w-full" style="margin: 0 !important; padding-right: 1rem; padding-left: 0 !important;">
        <!-- Header -->
        <div class="text-white rounded-2xl p-8 mb-4 text-center border-2" style="background: rgba(45, 90, 61, 0.4); backdrop-filter: blur(15px); border-color: rgba(163, 230, 53, 0.3);">
            <div class="flex flex-col items-center justify-center gap-3">
                @if(Auth::check() && Auth::user()->role === 'owner')
                    <h1 class="text-5xl font-bold" style="color: #a3e635;">🔑 Dashboard Owner</h1>
                    <p class="text-white/90 text-base">Kelola dan pantau semua aspek bisnis Ruang Aksara</p>
                @else
                    <h1 class="text-5xl font-bold" style="color: #a3e635;">📊 Dashboard Admin</h1>
                    <p class="text-white/90 text-base">Kelola inventori, pesanan, dan transaksi toko online Ruang Aksara</p>
                @endif
            </div>
        </div>
                    ...
                    <div class="flex-1 overflow-y-auto">
                        ...
                        <a href="{{ route('admin.books.edit', $book) }}" class="flex items-center justify-between py-2 border-b last:border-b-0 hover:bg-gray-50 -mx-2 px-2 rounded transition">
                            ...
                            <div class="text-right ml-2">
                                ...
                                @if(($book->stok ?? 0) <= ($alertThreshold ?? 5))
                    ...
                    <div class="flex-1 overflow-y-auto">
                        ...
                        <a href="{{ route('admin.loan-stock.index') }}" class="flex items-center justify-between py-2 border-b last:border-b-0 hover:bg-gray-50 -mx-2 px-2 rounded transition">
                            ...
                            <div class="text-right ml-2">
                                ...
                                @if(($book->loan_stok ?? 0) <= ($alertThreshold ?? 5))
            ...
            <div class="p-3">
                <div class="grid grid-cols-4 lg:grid-cols-5 gap-2">
                    ...
                    <a href="{{ route('admin.loans.index') }}" 
                       class="action-btn bg-gradient-to-br from-orange-500 to-orange-600 hover:from-orange-600 hover:to-orange-700 text-white p-4 rounded-lg text-center shadow-md">
