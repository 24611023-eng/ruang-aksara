        ...
        <div class="flex flex-row gap-8 items-center">
            <div class="flex-1">
                <h1 class="text-5xl font-bold" style="color: #a3e635;">
                    📚 Tambah Buku Peminjaman
                </h1>
                <p class="text-white/90 text-base mt-2">Lengkapi detail buku yang akan tersedia untuk dipinjam</p>
            </div>
            <div class="flex-shrink-0">
                <a href="{{ route('admin.loan-stock.index') }}" class="inline-flex items-center px-6 py-3 rounded-lg transition font-medium" style="background: #a3e635; color: #1e3e2a;">
