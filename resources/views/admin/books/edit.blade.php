    ...
    <div class="max-w-4xl mx-auto">
        <div class="text-white rounded-2xl p-8 mb-6 border-2" style="background: rgba(45, 90, 61, 0.4); backdrop-filter: blur(15px); border-color: rgba(163, 230, 53, 0.3);">
            <div class="flex flex-row gap-8 items-center">
                <div class="flex-1">
                    <h1 class="text-5xl font-bold" style="color: #a3e635;">✏️ Edit Buku</h1>
                    <p class="text-white/90 text-base mt-2">Perbarui informasi buku yang tersedia di katalog</p>
                </div>
                <div class="flex-shrink-0">
                    <a href="{{ route('admin.books.index') }}" class="inline-flex items-center px-6 py-3 rounded-lg transition font-medium" style="background: #a3e635; color: #1e3e2a;">
