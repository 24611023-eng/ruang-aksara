                ...
                <header class="hero-header">
                    <div class="hero-text">
                        <div class="hero-title-row">
                            ...
                            <h1 style="color: #a3e635; font-size: 2.25rem; margin: 0; font-weight: 800; text-shadow: 0 2px 8px rgba(0, 0, 0, 0.3); letter-spacing: -0.5px;">Peminjaman Buku Saya</h1>
                        </div>
                        <p style="color: #ffffff; font-size: 1.05rem; margin: 0; text-shadow: 0 1px 4px rgba(0, 0, 0, 0.3); font-weight: 500;">Pantau status peminjaman buku Anda dari toko offline</p>
                    </div>
                </header>
