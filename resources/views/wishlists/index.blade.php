...
<head>
    ...
    <style>
        ...
        .footer {
            ...
            /* Main wrapper should grow to take available space */
            .main-wrapper {
                display: flex;
                flex-direction: column;
                flex: 1 1 auto;
                ...
                <header class="hero-header">
                    <div class="hero-text">
                        <div class="hero-title-row">
                            ...
                            <h1 style="color: #a3e635; font-size: 2.25rem; margin: 0; font-weight: 800; text-shadow: 0 2px 8px rgba(0, 0, 0, 0.3); letter-spacing: -0.5px;">Wishlist Saya</h1>
                        </div>
                        <p style="color: #ffffff; font-size: 1.05rem; margin: 0; text-shadow: 0 1px 4px rgba(0, 0, 0, 0.3); font-weight: 500;">Kumpulan buku yang ingin Anda baca nanti</p>
                    </div>
                </header>
