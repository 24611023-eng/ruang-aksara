...
<body class="bg-gray-100">
    @if($useSidebarLayout)
        ...
        <!-- FOOTER for sidebar layout (cart.* when user) -->
        @include('partials.welcome-footer', ['hasSidebar' => true])
    @else
                ...
                <div class="flex items-center space-x-8">
                    ...
                    @else
                        <!-- HEADER USER BIASA - SAMA PERSIS STYLENYA -->
                            ...
                            <a href="{{ url('/') }}" class="text-xl font-bold logo flex items-center" style="color:#FFD600;">
                        ...
                        @else
                            <a href="{{ url('/') }}" class="text-xl font-bold logo"><span style="color:#FFD600">Ruang Aksara</span></a>
                        @endif
