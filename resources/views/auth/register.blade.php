        ...
        <div class="register-box">
            <div class="logo">
                @if(file_exists(public_path('images/ruang-aksara-logo-fix.jpeg')))
                    <img src="{{ asset('images/ruang-aksara-logo-fix.jpeg') }}" alt="Ruang Aksara" style="width:80px;height:80px;object-fit:contain;border-radius:8px;display:inline-block;margin-bottom:1rem;" />
                @elseif(file_exists(public_path('images/logo.png')))
                    <img src="{{ asset('images/logo.png') }}" alt="Ruang Aksara" style="width:80px;height:80px;object-fit:contain;display:inline-block;margin-bottom:1rem;" />
                @else
