...
<head>
    ...
    <style>
        ...
        .highlight-card h4 { color: #e2e8f0; }
...
<body>
    ...
    <section class="relative z-10 py-16">
        <div class="container mx-auto px-4 space-y-10">
            <div class="text-center space-y-2">
                <p class="text-sm uppercase tracking-[0.3rem] text-lime-200">Mengapa Ruang Aksara?</p>
                <h2 class="text-3xl font-bold text-white">Lebih dari sekadar toko buku</h2>
                <p class="text-gray-200 max-w-3xl mx-auto">Kurasi judul yang hangat, layanan ramah, dan opsi pengambilan langsung di lokasi kampus untuk Anda yang ingin dekat dengan buku-buku terbaik.</p>
            </div>

            <div class="grid gap-4 md:grid-cols-3">
                <div class="highlight-card">
                    <div class="flex items-center gap-3 mb-2">
                        <span class="inline-flex h-12 w-12 items-center justify-center rounded-full bg-lime-200/20 text-lime-200 text-2xl"><i class="fas fa-wand-magic-sparkles"></i></span>
                        <h4 class="text-xl font-semibold">Kurasi Hangat</h4>
                    </div>
                    <p>Buku pilihan dengan penekanan pada kualitas cerita, manfaat, dan ulasan pembaca.</p>
                </div>

                <div class="highlight-card">
                    <div class="flex items-center gap-3 mb-2">
                        <span class="inline-flex h-12 w-12 items-center justify-center rounded-full bg-lime-200/20 text-lime-200 text-2xl"><i class="fas fa-hand-holding-heart"></i></span>
                        <h4 class="text-xl font-semibold">Layanan Bersahabat</h4>
                    </div>
                    <p>Tim support cepat membalas, bantuan rekomendasi, dan update pesanan yang jelas.</p>
                </div>

                <div class="highlight-card">
                    <div class="flex items-center gap-3 mb-2">
                        <span class="inline-flex h-12 w-12 items-center justify-center rounded-full bg-lime-200/20 text-lime-200 text-2xl"><i class="fas fa-store"></i></span>
                        <h4 class="text-xl font-semibold">Ambil di Lokasi</h4>
                    </div>
                    <p>Butuh cepat? Ambil langsung di lokasi kami di Campus UII Main Library, Sleman.</p>
                </div>
            </div>

            <div class="grid gap-8 lg:grid-cols-2 items-center">
                <div class="space-y-3">
                    <p class="text-sm uppercase tracking-[0.25rem] text-lime-200">Lokasi Kami</p>
                    <h3 class="text-2xl font-bold text-white">Campus UII Main Library, Sleman</h3>
                    <p class="text-gray-200">Kunjungi kami untuk diskusi buku, ambil pesanan, atau sekadar mencari rekomendasi baru dari tim kami.</p>
                    <div class="grid sm:grid-cols-2 gap-3">
                        <div class="highlight-card">
                            <div class="flex items-center gap-2 text-lime-200 mb-1"><i class="fas fa-clock"></i><span class="font-semibold">Jam Operasional</span></div>
                            <p class="text-sm">Senin - Sabtu: 09.00 - 17.00<br>Minggu: Tutup</p>
                        </div>
                        <div class="highlight-card">
                            <div class="flex items-center gap-2 text-lime-200 mb-1"><i class="fas fa-phone"></i><span class="font-semibold">Kontak Cepat</span></div>
                            <p class="text-sm">Telp: (0274) 123-456<br>WA: 081335833583</p>
                        </div>
                    </div>
                </div>

                <div class="map-embed">
                    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d63257.89233435028!2d110.37231010493694!3d-7.72404092718699!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e7a5e98332c8e29%3A0x44459c015e1fefba!2sCampus%20UII%20Main%20Library!5e0!3m2!1sen!2sid!4v1767418495615!5m2!1sen!2sid" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                </div>
            </div>
        </div>
    </section>
    ...
    <!-- Footer -->
    <footer class="text-white py-6" style="background: linear-gradient(135deg, #2d5a3d 0%, #1e3e2a 100%) !important;">
        <div class="max-w-6xl mx-auto px-4">
            ...
            <div class="border-t border-white/20 mt-6 pt-3 text-center text-gray-200 text-sm">
                <p>&copy; 2026 Ruang Aksara. All rights reserved.</p>
            </div>
        </div>
    </footer>
