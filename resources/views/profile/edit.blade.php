        ...
        <div class="content-wrapper">
            <div class="mx-auto max-w-6xl space-y-6">
                <div class="profile-page-header">
                    ...
                    <p>Kelola informasi akun, alamat, dan keamanan profil Anda</p>
                </div>
                        ...
                        <form id="profile-form" action="{{ route('profile.update') }}" method="POST" class="space-y-6">
                            ...
                            <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
                                ...
                                <div>
                                    ...
                                    <input type="date" name="tanggal_lahir" class="form-input" value="{{ old('tanggal_lahir', Auth::user()->tanggal_lahir ? \Carbon\Carbon::parse(Auth::user()->tanggal_lahir)->format('Y-m-d') : '') }}">
                                </div>
                            </div>
                            ...
                            <div class="grid grid-cols-1 gap-4 md:grid-cols-2 mt-4">
                                <div>
                                    ...
                                    <input type="text" name="nik" class="form-input" value="{{ old('nik', Auth::user()->nik ?? '') }}" placeholder="Nomor Induk Kependudukan">
                                    <p class="text-sm text-gray-500 mt-1">Masukkan NIK (opsional).</p>
                                </div>
                                <div>
        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            if (profileForm) {
                profileForm.addEventListener('submit', (event) => {
                    ...
                    const originalTanggalLahir = "{{ Auth::user()->tanggal_lahir ? \Carbon\Carbon::parse(Auth::user()->tanggal_lahir)->format('Y-m-d') : '' }}";
