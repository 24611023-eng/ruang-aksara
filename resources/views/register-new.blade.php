        ...
        <div class="text-center mb-8">
            <h1 class="text-4xl md:text-5xl font-bold text-white mb-3">
                @if(file_exists(public_path('images/ruang-aksara-logo-fix.jpeg')))
                    <img src="{{ asset('images/ruang-aksara-logo-fix.jpeg') }}" alt="Ruang Aksara" style="width:80px;height:80px;object-fit:contain;display:inline-block;margin-right:0.25rem;vertical-align:middle;border-radius:8px;" />
                @elseif(file_exists(public_path('images/logo.png')))
                    <img src="{{ asset('images/logo.png') }}" alt="Ruang Aksara" style="width:80px;height:80px;object-fit:contain;display:inline-block;margin-right:0.25rem;vertical-align:middle;" />
                @else
                    <i class="fas fa-book mr-2"></i>
                @endif
                <span style="color:#FFD600; vertical-align:middle;">Ruang Aksara</span>
            </h1>
